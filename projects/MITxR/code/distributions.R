...
setwd("C:/Users/snara016/OneDrive - Ascension/Documents/RWork/projects/MITxR")
...
ggplot(bihar_adult_females_trunc, aes(height_cm))+
  geom_histogram(data=bihar_adult_females_trunc, aes(height_cm, ..density.. ),fill="blue", color="blue")+
  geom_histogram(data=us_adult_females_trunc, aes(height_cm , ..density..), fill="red", color="red" )+
  xlab("Height in centimeters")

# more visible as points 

ggplot(bihar_adult_females_trunc, aes(height_cm))+
  geom_freqpoly(data=bihar_adult_females_trunc, aes(height_cm, ..density.. ), color="blue" )+
  geom_freqpoly(data=us_adult_females_trunc, aes(height_cm , ..density..),  color="red" )+
  xlab("Height in centimeters")
